    ...
    routes: [
        {
            ...
            props: route => ({ user: route.params.user }) // Pass routing parameters as props to components
        },
        {
            path: '/',          
            redirect: '/login'  
...
router.beforeEach((to, from, next) => {
    ...
    // If the route needs to jump to interfaces other than login and registration, check if it has already logged in.
    // If it has not logged in, force it to jump to the login interface
