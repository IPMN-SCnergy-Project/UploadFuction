...
<script>
import Upload from '../upload/Upload.vue'; // import upload component
...
export default {
  ...
  components: {
    Upload // register upload component
  },
...
.container {
  ...
  height: 100vh; /* Set the container height to the window height */
}
...
.grid-container {
  ...
  height: 6000px; /* Set container height to page height */
  padding: 20px 20px;
  border-radius: 10px;
